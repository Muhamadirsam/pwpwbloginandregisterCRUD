...
<body>
    <section>
        ...
        <center>
            ...
            <p>Hello,</p>
            <p>I&#8217;M irsam </p>
            <p>belajar SMKN 1 CIAMIS</p>
            <p>ya.....
            <br>Gabung Disini Yah...</p>
            <button class="hire-btn"><a href="formLogin.php">LOGIN</a></button>
            <button class="down-cv"><a href="formRegister.php">REGISTER</a></button>
        </div>
        <!--- text --->
        <img alt="model" class="model" src="ya.png">
    </center>
    </section>  
    ...
    <!-- footer -->
    <footer>
        <p>Apakah mau mengobrol dengan saya?</p>
